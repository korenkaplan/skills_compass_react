...
const Content: React.FC<ContentProps> = ({
  ...
  return (
    <div style={{marginTop: isMobile ? `${appBarHeight + appBarHeight + extraSpaceFromAppBarInPx}px` : '0px'}} className={isMobile ? "sectionsWrapperMobile" : "sectionsWrapperDesktop"}>
