  ...
  return (
    <div className="section main heightAndBorder" >
      ...
      <div className="textContainerLandingPage">
        ...
        <h2 className='headerLandingPageMobile'>Discover the <strong className='highlighted'>Most Wanted </strong> Skills  for your job in <br /> Israel's High-Tech industry</h2>
      </div>
