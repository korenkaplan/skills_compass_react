...
import { backgroundColor, contrastColor } from '../../utils/variables'
    ...
    <div style={{ padding: 50 }} className="section OverviewContainerDesktop heightAndBorder">
      <div className="textContainerDesktop" dir={isRotated ? 'rtl' : 'ltr'}>
        <Reveal>
          <div className="containerHeaderDesktop">
            ...
            <ScaleOnTapButtonWrapper>
              <div className='custom-button translateButtonDivDesktop' onClick={handleRotate}>
        ...
        <div className="containerTextDesktop" dir={isRotated ? 'rtl' : 'ltr'}>
          ...
          <Reveal>
            <ScaleOnTapButtonWrapper>
              <div className='buttonAndMouseScrollDiv'>
                <ScrollDownMouseAnimation scrollDown={() => { }} style={getScrollDownAnimationStyle()} />
                <button className='overviewPageBottomButton'>
                  <p className='bottomButtonWordsDesktop'>{bottomWords}</p>
                </button>
              </div>
            </ScaleOnTapButtonWrapper>
          </Reveal>
