...
<div style={{ lineHeight: '30px', fontSize: '18px' }}>
  ...
  const aboutMeParagraphHebrew = (
    <div style={{ lineHeight: '30px', fontSize: '18px' }}>
      ...
      <p>אני קורן קפלן, מפתח תוכנה בן 27 שפשוט אוהב לתכנת וללמוד דברים חדשים. לאחרונה סיימתי בהצטיינות יתרה לימודי הנדסאי תוכנה במכללת רופין, כשקיבלתי ציון של 95. 🎓</p>
